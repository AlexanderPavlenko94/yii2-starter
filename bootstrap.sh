...
pwd
echo vagrant | sudo -S wget http://xdebug.org/files/xdebug-2.5.0.tgz
echo vagrant | sudo -S tar -xvzf xdebug-2.5.0.tgz
cd xdebug-2.5.0
echo vagrant | sudo -S apt-get install php7.0-dev -y
echo vagrant | sudo -S phpize
echo vagrant | sudo -S ./configure
echo vagrant | sudo -S make
echo vagrant | sudo -S cp modules/xdebug.so /usr/lib/php/20151012
cd -
...
echo vagrant | sudo -S service php7.0-fpm restart
echo "Migrating..."
